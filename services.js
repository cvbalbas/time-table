...
function getTutorNames(callback){
    var tutorNames = []
    var sql = "SELECT table_name FROM information_schema.tables WHERE table_schema = '"+process.env.DATABASE+"';"
    con.query(sql, function (err, result) { 
        if (err) throw err;
